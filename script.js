document.addEventListener("DOMContentLoaded", () => {
    ...
    const validateEmail = () => {
        ...
        if (!value || !expresionRegular.test(value)) {
            mostrarError(errEmail, "El email debe tener el formato nombre@dominio.com");
            return false;
        }
    ...
    if (form) { // Solo si el formulario existe en la página actual
    ...
    const productos = [
        { id: "hamburgon-clasico", nombre: "Hamburgon Clásico", precio: 8000, imagen: "images/HamburgonClasico2.png!sw800" },
        { id: "hamburgon-cheddar", nombre: "Hamburgon con Cheddar", precio: 9500, imagen: "images/HamburgonDobleConCheddar.png" },
        { id: "hamburgon-bbq", nombre: "Hamburgon BBQ", precio: 9500, imagen: "images/HamburgonBBQ3.png" },
        { id: "hamburgon-vegano", nombre: "Hamburgon Vegano", precio: 10500, imagen: "images/HamburgonVegano.png" },
        { id: "hamburgon-pollo", nombre: "Hamburgon de Pollo", precio: 10500, imagen: "images/HamburgonPollo.png" },
        { id: "hamburgon-premium", nombre: "Hamburgon Premium", precio: 12000, imagen: "images/HamburgonPremium.jpg" },
        { id: "sanguchon-vacio", nombre: "Sanguchon de Vacio", precio: 9000, imagen: "images/SanguchonVacio.jpg" },
        { id: "sanguchon-bondiola", nombre: "Sanguchon de Bondiola", precio: 9000, imagen: "images/SanguchonBondiola.jpg" },
        { id: "sanguchon-milanesa", nombre: "Sanguchon de Milanesa", precio: 7500, imagen: "images/SanguchonMilanesa.jpg" }
    ];
    ...
    function cargarProductosCarrito() {
        if (carrito.length === 0) {
            if (contenedorCarritoProductos) contenedorCarritoProductos.innerHTML = `<p class="carrito-vacio-mensaje">Tu carrito está vacío. ¡Agrega algunos productos!</p>`;
    ...
    if (window.location.pathname.includes("carrito.html")) {
        ...
        // Asegurarse de que el numerito se actualice en todas las páginas
        actualizarNumerito();
    }
});
